          ...
          <div className="lg:col-span-6 space-y-6 flex flex-col justify-center">
            ...
            <div className="space-y-3.5 pt-2">
              {checklist.map((item, idx) => (
                <div key={idx} className="ca-check-fade flex items-center gap-3">
            ...
            {/* Bottom info note */}
            <div className="ca-text-fade border-t border-white/10 pt-5 mt-2">
              <p className="text-white/85 text-xs sm:text-sm leading-relaxed font-normal">
                Perfect for bedrooms, living rooms, conference rooms, and large window areas.
              </p>
            </div>
