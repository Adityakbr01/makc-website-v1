...
export function RegisterForm({ onSuccess, onToggleForm, onClose }: RegisterFormProps) {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-medium-text-secondary">
            Join MAKc Automations for exclusive design insight.
          </p>
        </div>
        <button
          onClick={onClose}
      ...
      <form onSubmit={handleSubmit} className="mt-6 space-y-4">
        <div>
          ...
          <div className="relative mt-1.5 flex items-center">
            <User className="absolute left-4 h-5 w-5 text-medium-text-secondary" />
            <input
              type="text"
              value={username}
