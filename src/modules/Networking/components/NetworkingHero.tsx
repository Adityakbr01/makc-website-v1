        ...
        <div className="max-w-3xl space-y-6 md:space-y-8">
          ...
          <div className="hero-subtitle max-w-2xl">
            <p className="text-base sm:text-lg text-white/80 leading-relaxed">
              A smart home or office is only as good as its network. With professionally designed networking 
              solutions in Bangalore, MAKc Automation ensures strong, secure, and uninterrupted connectivity across 
              every corner of your space. Designed for homes, villas, apartments, offices, and commercial spaces.
              <img
